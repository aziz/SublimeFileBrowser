...
from os.path import basename, dirname, isdir, exists, join, normpath

ST3 = int(sublime.version()) >= 3000

if ST3:
    from .common import DiredBaseCommand, sort_nicely, print, set_proper_scheme, calc_width, NT, LIN, OSX, PARENT_SYM
    from . import prompt
